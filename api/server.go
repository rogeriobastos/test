...
func main() {
	...
	// analysis routes
	a := echoInstance.Group("/analysis")
	a.Use(middleware.KeyAuthWithConfig(middleware.KeyAuthConfig {
		KeyLookup: "header:Husky-Token",
		Validator: func(key string, c echo.Context) (bool, error) {
			return key == "aiSh7aijiti0moh1caubquaeZa4ufoow8otieNg6", nil
		},
	}))
	a.POST("", routes.ReceiveRequest)
	a.GET("/:id", routes.GetAnalysis)
